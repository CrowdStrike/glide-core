...
test(
  'checked and not indeterminate when unchecked and indeterminate and clicked via mouse',
  { tag: '@mouse' },
  async ({ mount, page }) => {
    await mount(
...
test(
  'unchecked and not indeterminate when checked and indeterminate and clicked via mouse',
  { tag: '@mouse' },
  async ({ mount, page }) => {
    await mount(
      html`<glide-core-checkbox
...
test(
  'unchecked on click when forcibly unchecked in an "input" handler and clicked via mouse',
  { tag: '@mouse' },
  async ({ mount, page }) => {
    await mount(
      html`<glide-core-checkbox label="Label"></glide-core-checkbox>`,
...
test(
  'remains unchecked on click when forcibly unchecked in a "change" handler and clicked via mouse',
  { tag: '@mouse' },
  async ({ mount, page }) => {
    await mount(
      html`<glide-core-checkbox label="Label"></glide-core-checkbox>`,
...
test(
  'remains unchecked when clicked via mouse and its "click" event is canceled',
  { tag: '@mouse' },
