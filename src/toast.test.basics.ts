...
// "transitionend" is dispatched manually throughout these tests because the
// event isn't emitted in CI. It's not clear why. But the below issue may be
// related.
//
...
it('can have a description', async () => {
  await fixture(
    html`<glide-core-toast label="Label">
      Description
      <glide-core-link label="Label" url="/"></glide-core-link>
    </glide-core-toast>`,
  );
