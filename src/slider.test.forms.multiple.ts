...
it('submits its form on Enter when the minimum thumb has focus', async () => {
  const form = document.createElement('form');
...
it('submits its form on Enter when the maximum thumb has focus', async () => {
  const form = document.createElement('form');
