...
it('makes focusable sub-Menu targets unfocusable', async () => {
  const host = await fixture<Menu>(
    html`<glide-core-menu>
      <button slot="target">Target</button>
...
it('closes open sub-Menus when not open', async () => {
  const host = await fixture<Menu>(
    html`<glide-core-menu>
      <button slot="target">Target</button>
...
it('closes all but the first open sub-Menu when multiple sub-Menus are open', async () => {
  const host = await fixture<Menu>(
    html`<glide-core-menu open>
      <button slot="target">Target</button>
...
it('throws when a sub-Menu and its target is an Input', async () => {
  await expectWindowError(() => {
    return fixture(
      html`<glide-core-menu>
        <button slot="target">Target</button>
