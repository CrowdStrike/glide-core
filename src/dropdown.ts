  ...
  implements FormControl
{
  ...
  */
  ...
  // Set to `true` when there are no slotted options.
  @state()
  private hasNoAvailableOptions = false;

  // Set to `true` when every option has been hidden by having been filtered
  // out. The names for both this and `isNoAvailableOptions` are not ideal.
  // But they're downstream of the copy provided for both states by Design.
  @state()
