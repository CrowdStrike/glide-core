...
// TODO: replace not:([name]) selects here and in other suites with data-test selector
...
// TODO: handle Enter and Spaces cases?
...
it('remains open when open and its target is clicked and the event is canceled on its target', async () => {
  const host = await fixture<Menu>(
    html`<glide-core-menu open>
      <button slot="target">Target</button>
...
it('remains open when open and its target is clicked and the event is canceled on Menu', async () => {
  const host = await fixture<Menu>(
    html`<glide-core-menu open>
      <button slot="target">Target</button>
...
it('remains closed when closed and its target is clicked and the event is canceled on its target', async () => {
  const host = await fixture<Menu>(
    html`<glide-core-menu>
      <button slot="target">Target</button>
...
it('remains closed when closed and its target is clicked and the event is canceled on Menu', async () => {
  const host = await fixture<Menu>(
    html`<glide-core-menu>
      <button slot="target">Target</button>
...
// TODO: test ArrowLeft. also changeset.
it('does not scroll on ArrowRight when open', async () => {
  ...
  await sendKeys({ press: 'Tab' });
  await sendKeys({ press: 'ArrowRight' });
  await aTimeout(100); // Give the browser a chance to scroll the page
...
it('does not scroll on ArrowLeft when open', async () => {
  document.body.style.width = '200vw';
  ...
  window.scroll(100, 0); // Scroll after tabbing because tabbing will scroll the page
...
it('opens submenus when submenu targets are clicked', async () => {
  const host = await fixture<Menu>(
    html`<glide-core-menu open>
      <button slot="target">Target</button>
...
it('closes child submenus when a the target of a parent submenu is disabled', async () => {
  const host = await fixture<Menu>(
    html`<glide-core-menu open>
      <button slot="target">Target</button>
        ...
        <glide-core-option label="One">
          <glide-core-menu slot="submenu" open>
            ...
            <glide-core-options>
              ...
              <glide-core-option label="Six" disabled></glide-core-option>
              <glide-core-option label="Seven"></glide-core-option>
            </glide-core-options>
          </glide-core-menu>
        </glide-core-option>

        <glide-core-option label="Eight" disabled></glide-core-option>
...
it('activates the next submenu option on ArrowDown when another option with a submenu is active', async () => {
  const host = await fixture<Menu>(
    html`<glide-core-menu open>
      <button slot="target">Target</button>
        ...
        <glide-core-option label="One">
          <glide-core-menu slot="submenu" open>
            ...
            <glide-core-options>
              ...
              <glide-core-option label="Five" disabled></glide-core-option>
              <glide-core-option label="Six"></glide-core-option>
            </glide-core-options>
          </glide-core-menu>
        </glide-core-option>

        <glide-core-option label="Seven" disabled></glide-core-option>
