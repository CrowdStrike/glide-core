...
it('remains open when the edge of its default slot or a sub-Menu default slot is clicked', async () => {
  const host = await fixture<Menu>(
...
it('remains open when its sub-Menu targets are opened via click', async () => {
  const host = await fixture<Menu>(
    html`<glide-core-menu open>
      <button slot="target">Target</button>
...
it('closes its nested sub-Menu when its parent Menu is closed', async () => {
  const host = await fixture<Menu>(
    html`<glide-core-menu open>
      <button slot="target">Target</button>
...
it('closes sibling sub-Menus when a sub-Menu is opened', async () => {
  const host = await fixture<Menu>(
    html`<glide-core-menu open>
      <button slot="target">Target</button>
...
it('closes child sub-Menus when the target of a parent sub-Menu is disabled', async () => {
  const host = await fixture<Menu>(
    html`<glide-core-menu open>
      <button slot="target">Target</button>
...
it('activates the first active Option when reopened and the previously active Option has been disabled', async () => {
  const host = await fixture<Menu>(html`
    <glide-core-menu open>
      <button slot="target">Target</button>
