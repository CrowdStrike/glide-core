  ...
  create(context) {
    ...
    return {
      ...
      MemberExpression(node) {
        // Covering every Chai property and combination thereof probably isn't worth our
        // time or the code weight. Instead, in an attempt to strike a balanace, I've
        // covered only the most commonly used properties and combinations.
        if (
          isProbablyATest &&
