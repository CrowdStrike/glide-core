...
// TODO: people and lint hooks will need a single command to check coverage
// for funcionality
// TODO: favion 404 in ui console
...
export const test = baseTest.extend<{
  ...
  async mount({ page }, use, testInfo) {
    await use(async function mount(template: TemplateResult): Promise<void> {
      ...
      // TODO: wrap all these in try/catch and log or throw error
        ...
        return [...template.content.querySelectorAll('*')]
          ...
          .every((element) => {
            ...
            console.log(
              'waitForFunction',
              element.tagName,
              window.customElements.get(element.tagName.toLowerCase()),
            );
