...
export default defineConfig([
  ...
  },
  {
    ...
    files: [
      ...
      'src/eslint/rules/no-tags-in-test-names.test.ts',
      'src/eslint/rules/no-test-fail.test.ts',
      'src/eslint/rules/no-test-fixme.test.ts',
      'src/eslint/rules/no-to-contain-class.test.ts',
      'src/eslint/rules/no-to-have-class.test.ts',
