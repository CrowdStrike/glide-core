...
exports.noSpacePress = createRule({
    name: 'no-space-press',
    meta: {
        docs: {
            description: 'Prefer using " " over "Space" when checking keys to align with the native key value. In application code, checking `event.key === "Space"` is incorrect, as " " is what key will be in this case. https://developer.mozilla.org/en-US/docs/Web/API/UI_Events/Keyboard_event_key_values#whitespace_keys',
            recommended: true,
        },
        type: 'suggestion',
        messages: {
