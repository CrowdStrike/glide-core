...
exports.noRedudantPropertyAttribute = void 0;
...
exports.noRedudantPropertyAttribute = createRule({
    name: 'no-redundant-property-attribute',
    meta: {
        docs: {
            description: 'Ensures the Lit property decorator does not specify an attribute key that matches the property name.',
            recommended: true,
        },
        type: 'suggestion',
        messages: {
            noRedudantPropertyAttribute: 'The "attribute" defined in the property decorator matches the property declaration name, making it redundant.  Please remove it.',
        },
        schema: [],
        fixable: 'code',
    },
        ...
        return {
            ...
            Decorator(node) {
                ...
                if (node.expression.type === utils_1.AST_NODE_TYPES.CallExpression &&
                    ...
                    if (nodeParent.type === utils_1.AST_NODE_TYPES.PropertyDefinition &&
                        nodeParent.key.type === utils_1.AST_NODE_TYPES.Identifier &&
                                        ...
                                        fix(fixer) {
                                            ...
                                            if (argument.properties?.length > 1) {
                                                ...
                                                if (!tokenBefore || !tokenAfter) {
                                                    ...
                                                    console.error(`Error attempting to lint fix "no-redundant-property-attribute" at range: ${property.range.toString()}". Please report this error to @crowdstrike/glide-core.`);
                                                    return null;
                                                }
