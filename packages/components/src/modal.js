 ...
 * @fires {Event} toggle
 */
let GlideCoreModal = class GlideCoreModal extends LitElement {
    constructor() {
        super(...arguments);
    ...
    firstUpdated() {
        ...
        // would suffice.
        this.#containerElementRef.value?.addEventListener('mouseup', this.#onContainerMousedown);
    }
...
], GlideCoreModal.prototype, "backButton", void 0);
__decorate([
    property({ reflect: true }),
    required
], GlideCoreModal.prototype, "label", void 0);
__decorate([
    property({ reflect: true, type: Boolean })
], GlideCoreModal.prototype, "open", null);
__decorate([
    property({ reflect: true })
], GlideCoreModal.prototype, "severity", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreModal.prototype, "size", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreModal.prototype, "version", void 0);
__decorate([
    state()
], GlideCoreModal.prototype, "hasPrimarySlotContent", void 0);
__decorate([
    state()
], GlideCoreModal.prototype, "hasSecondarySlotContent", void 0);
__decorate([
    state()
], GlideCoreModal.prototype, "hasTertiarySlotContent", void 0);
GlideCoreModal = __decorate([
    customElement('glide-core-modal'),
    final
], GlideCoreModal);
export default GlideCoreModal;
const icons = {
    back: html `
    <svg
      style=${styleMap({
