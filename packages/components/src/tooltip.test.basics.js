...
let GlideCoreSubclassed = class GlideCoreSubclassed extends GlideCoreTooltip {
};
...
it('throws when it does not have a default slot', async () => {
    await expectUnhandledRejection(() => {
        return fixture(html `<glide-core-tooltip label="Label"></glide-core-tooltip>`);
    });
});
it('throws when it does not have a "target" slot', async () => {
    await expectUnhandledRejection(() => {
        return fixture(html `<glide-core-tooltip label="Label">Tooltip</glide-core-tooltip>`);
    });
});
it('has `placement="top"` coverage', async () => {
    await fixture(html `<glide-core-tooltip label="Label" placement="top" open>
      <button slot="target">Target</button>
    </glide-core-tooltip>`);
});
