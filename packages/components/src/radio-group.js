 ...
 * @param {string} [message]
 */
let GlideCoreRadioGroup = class GlideCoreRadioGroup extends LitElement {
    ...
    set disabled(isDisabled) {
        ...
        for (const radio of this.#radioElements) {
            ...
            const firstCheckedRadio = this.#radioElements.find((radio) => radio.checked);
    ...
    get #radioElements() {
        return this.#defaultSlotElementRef.value
            ? this.#defaultSlotElementRef.value
                .assignedElements()
                .filter((element) => element instanceof GlideCoreRadioGroupRadio)
            : [];
    }
    ...
    #onRadiosValueChange(event) {
        ...
        else if (event.target instanceof GlideCoreRadioGroupRadio &&
            event.target.checked) {
            this.#value = '';
        }
    }
...
], GlideCoreRadioGroup.prototype, "disabled", null);
__decorate([
    property({ attribute: 'hide-label', type: Boolean })
], GlideCoreRadioGroup.prototype, "hideLabel", void 0);
__decorate([
    property({ reflect: true }),
    required
], GlideCoreRadioGroup.prototype, "label", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreRadioGroup.prototype, "name", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreRadioGroup.prototype, "orientation", void 0);
__decorate([
    property()
], GlideCoreRadioGroup.prototype, "privateSplit", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreRadioGroup.prototype, "tooltip", void 0);
__decorate([
    property({ reflect: true, type: Boolean })
], GlideCoreRadioGroup.prototype, "required", null);
__decorate([
    property()
], GlideCoreRadioGroup.prototype, "value", null);
__decorate([
    property({ reflect: true })
], GlideCoreRadioGroup.prototype, "version", void 0);
__decorate([
    state()
], GlideCoreRadioGroup.prototype, "isBlurring", void 0);
__decorate([
    state()
], GlideCoreRadioGroup.prototype, "isCheckingValidity", void 0);
__decorate([
    state()
], GlideCoreRadioGroup.prototype, "isReportValidityOrSubmit", void 0);
__decorate([
    state()
], GlideCoreRadioGroup.prototype, "validityMessage", void 0);
GlideCoreRadioGroup = __decorate([
    customElement('glide-core-radio-group'),
    final
], GlideCoreRadioGroup);
export default GlideCoreRadioGroup;
