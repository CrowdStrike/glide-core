 ...
 * @fires {Event} toggle
 */
let GlideCorePopover = class GlideCorePopover extends LitElement {
    constructor() {
        super(...arguments);
...
], GlideCorePopover.prototype, "disabled", null);
__decorate([
    property({ reflect: true, type: Number })
], GlideCorePopover.prototype, "offset", null);
__decorate([
    property({ reflect: true, type: Boolean })
], GlideCorePopover.prototype, "open", null);
__decorate([
    property()
], GlideCorePopover.prototype, "placement", void 0);
__decorate([
    property({ reflect: true })
], GlideCorePopover.prototype, "version", void 0);
__decorate([
    state()
], GlideCorePopover.prototype, "effectivePlacement", void 0);
GlideCorePopover = __decorate([
    customElement('glide-core-popover'),
    final
], GlideCorePopover);
export default GlideCorePopover;
const icons = {
    topArrow: html `
