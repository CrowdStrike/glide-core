...
const meta = {
    ...
    argTypes: {
        'slot="default"': {
            table: {
                type: {
                    summary: 'GlideCoreCheckbox | GlideCoreCheckboxGroup | GlideCoreDropdown | GlideCoreRadioGroup | GlideCoreInput | GlideCoreTextArea',
                },
            },
    ...
    play(context) {
        const checkboxGroup = context.canvasElement.querySelector('glide-core-checkbox-group');
        ...
        const option = context.canvasElement.querySelector('glide-core-dropdown-option');
        ...
        const radioGroup = context.canvasElement.querySelector('glide-core-radio-group');
            ...
            if (event.target instanceof GlideCoreRadioGroupRadio) {
                addons.getChannel().emit(UPDATE_STORY_ARGS, {
                    ...
                    updatedArgs: {
                        ...
                        '<glide-core-radio-group-radio>.one.checked': event.target.value === 'one',
                        '<glide-core-radio-group-radio>.two.checked': event.target.value === 'two',
                        '<glide-core-radio-group-radio>.three.checked': event.target.value === 'three',
                    },
                });
            }
        });
      ...
      <glide-core-form-controls-layout split=${arguments_.split}>
        <glide-core-checkbox-group label="Label">
          <glide-core-checkbox
            label="One"
            value="one"
            ?checked=${arguments_['<glide-core-checkbox-group>.value'].includes('one')}
          ></glide-core-checkbox>
          <glide-core-checkbox
            label="Two"
            value="two"
            ?checked=${arguments_['<glide-core-checkbox-group>.value'].includes('two')}
          ></glide-core-checkbox>
          <glide-core-checkbox
            label="Three"
            value="three"
            ?checked=${arguments_['<glide-core-checkbox-group>.value'].includes('three')}
          ></glide-core-checkbox>
        ...
        >
          <glide-core-dropdown-option
            label="One"
            value="one"
            ?selected=${arguments_['<glide-core-dropdown>.value'].includes('one')}
          ></glide-core-dropdown-option>

          <glide-core-dropdown-option
            label="Two"
            value="two"
            ?selected=${arguments_['<glide-core-dropdown>.value'].includes('two')}
          ></glide-core-dropdown-option>

          <glide-core-dropdown-option
            label="Three"
            value="three"
            ?selected=${arguments_['<glide-core-dropdown>.value'].includes('three')}
          ></glide-core-dropdown-option>
        </glide-core-dropdown>
