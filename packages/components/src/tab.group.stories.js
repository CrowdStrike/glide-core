...
const meta = {
    ...
    render(arguments_) {
      ...
      <glide-core-tab-group
        style=${styleMap({
            '--tabs-padding-block-start': arguments_['--tabs-padding-block-start'] || null,
            '--tabs-padding-block-end': arguments_['--tabs-padding-block-end'] || null,
            '--tabs-padding-inline-start': arguments_['--tabs-padding-inline-start'] || null,
            '--tabs-padding-inline-end': arguments_['--tabs-padding-inline-end'] || null,
        })}
      >
        <glide-core-tab
          slot="nav"
        ...
        <glide-core-tab-panel
          name="1"
          style=${styleMap({
            '--padding-inline-end': arguments_['<glide-core-tab-panel>[--padding-inline-end]'] ||
                null,
            '--padding-inline-start': arguments_['<glide-core-tab-panel>[--padding-inline-start]'] ||
                null,
        })}
        >
