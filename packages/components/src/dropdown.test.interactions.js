...
it('does not open when opened programmatically and there are no options', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label"> </glide-core-dropdown>`);
    host.open = true;
    // Wait for Floating UI.
    await aTimeout(0);
    const options = host.shadowRoot?.querySelector('[data-test="options"]');
...
it('does not open on ArrowUp when disabled', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label" disabled>
      <glide-core-dropdown-option label="Label"></glide-core-dropdown-option>
    </glide-core-dropdown>`);
    await sendKeys({ press: 'Tab' });
    await sendKeys({ press: 'ArrowUp' });
...
it('does not open on ArrowUp when `readonly`', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label" readonly>
      <glide-core-dropdown-option label="Label"></glide-core-dropdown-option>
    </glide-core-dropdown>`);
    await sendKeys({ press: 'Tab' });
    await sendKeys({ press: 'ArrowUp' });
...
it('does not scroll the page on ArrowDown when the Add button has focus', async () => {
    ...
    await fixture(html `<glide-core-dropdown add-button-label="Add" label="Label" open>
      <glide-core-dropdown-option label="Label"></glide-core-dropdown-option>
    </glide-core-dropdown>`);
    // Wait for Floating UI.
    await aTimeout(0);
...
it('closes when the Add button is clicked', async () => {
    const host = await fixture(html `<glide-core-dropdown add-button-label="Add" label="Label" open>
      <glide-core-dropdown-option label="Label"></glide-core-dropdown-option>
    </glide-core-dropdown>`);
    // Wait for Floating UI.
    await aTimeout(0);
...
it('opens when open and enabled programmatically', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label" open disabled>
      <glide-core-dropdown-option
        label="Label"
        selected
      ></glide-core-dropdown-option>
...
it('opens when something other than its primary button is clicked', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label" placeholder="Placeholder">
      <glide-core-dropdown-option label="Label"></glide-core-dropdown-option>
    </glide-core-dropdown>`);
