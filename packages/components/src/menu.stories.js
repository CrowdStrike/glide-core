    ...
    argTypes: {
        ...
        'slot="target"': {
            table: {
                type: {
                    summary: 'Element',
                    detail: 'The element to which the menu will anchor. Can be any focusable element',
                },
            },
            type: { name: 'function', required: true },
        },
        'addEventListener(event, handler)': {
            ...
            table: {
                type: {
                    summary: 'method',
                    detail: '(event: "click" | "toggle", handler: (event: Event) => void): void',
                },
            },
        },
        offset: {
        ...
        placement: {
            ...
            table: {
                ...
                type: {
                    summary: '"bottom" | "left" | "right" | "top" | "bottom-start" | "bottom-end" | "left-start" | "left-end" | "right-start" | "right-end" | "top-start"| "top-end"',
                },
            },
        },
        size: {
