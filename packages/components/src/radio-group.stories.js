            ...
            if (event.target instanceof GlideCoreRadioGroupRadio) {
                ...
                addons.getChannel().emit(UPDATE_STORY_ARGS, {
                    ...
                    updatedArgs: {
                        ...
                        '<glide-core-radio-group-radio>.one.checked': event.target.id === 'one',
                        '<glide-core-radio-group-radio>.two.checked': event.target.id === 'two',
                        '<glide-core-radio-group-radio>.three.checked': event.target.id === 'three',
                    },
                });
            }
        });
