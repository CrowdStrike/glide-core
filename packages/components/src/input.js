 ...
 * @param {string} [message]
 */
let GlideCoreInput = class GlideCoreInput extends LitElement {
...
], GlideCoreInput.prototype, "type", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreInput.prototype, "name", void 0);
__decorate([
    property()
], GlideCoreInput.prototype, "value", void 0);
__decorate([
    property({ reflect: true }),
    required
], GlideCoreInput.prototype, "label", void 0);
__decorate([
    property({ attribute: 'hide-label', type: Boolean })
], GlideCoreInput.prototype, "hideLabel", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreInput.prototype, "orientation", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreInput.prototype, "pattern", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreInput.prototype, "placeholder", void 0);
__decorate([
    property({ type: Boolean })
], GlideCoreInput.prototype, "clearable", void 0);
__decorate([
    property({ reflect: true, type: Boolean })
], GlideCoreInput.prototype, "spellcheck", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreInput.prototype, "autocapitalize", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreInput.prototype, "autocomplete", void 0);
__decorate([
    property({ attribute: 'password-toggle', type: Boolean })
], GlideCoreInput.prototype, "passwordToggle", void 0);
__decorate([
    property({ reflect: true, type: Boolean })
], GlideCoreInput.prototype, "required", void 0);
__decorate([
    property({ type: Boolean })
], GlideCoreInput.prototype, "readonly", void 0);
__decorate([
    property({ reflect: true, type: Boolean })
], GlideCoreInput.prototype, "disabled", void 0);
__decorate([
    property()
], GlideCoreInput.prototype, "privateSplit", void 0);
__decorate([
    property({
        type: Number,
        converter(value) {
...
], GlideCoreInput.prototype, "maxlength", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreInput.prototype, "version", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreInput.prototype, "tooltip", void 0);
__decorate([
    state()
], GlideCoreInput.prototype, "hasFocus", void 0);
__decorate([
    state()
], GlideCoreInput.prototype, "isBlurring", void 0);
__decorate([
    state()
], GlideCoreInput.prototype, "isCheckingValidity", void 0);
__decorate([
    state()
], GlideCoreInput.prototype, "isReportValidityOrSubmit", void 0);
__decorate([
    state()
], GlideCoreInput.prototype, "passwordVisible", void 0);
__decorate([
    state()
], GlideCoreInput.prototype, "validityMessage", void 0);
GlideCoreInput = __decorate([
    customElement('glide-core-input'),
    final
], GlideCoreInput);
export default GlideCoreInput;
const icons = {
    eye: html `<svg
    aria-hidden="true"
    style=${styleMap({
