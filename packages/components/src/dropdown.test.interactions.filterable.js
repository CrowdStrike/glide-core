import { assert, aTimeout, expect, fixture, html, oneEvent, waitUntil, } from '@open-wc/testing';
...
it('opens on click', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label" filterable>
...
it('closes on click', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label" filterable open>
      <glide-core-dropdown-option label="One"></glide-core-dropdown-option>
      <glide-core-dropdown-option label="Two"></glide-core-dropdown-option>
    </glide-core-dropdown>`);
...
it('unfilters on Backspace', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label">
      <glide-core-dropdown-option label="One"></glide-core-dropdown-option>
      <glide-core-dropdown-option label="Two"></glide-core-dropdown-option>
    </glide-core-dropdown>`);
    host.focus();
...
it('shows its magnifying glass icon when single-select and filtering', async () => {
    ...
    await sendKeys({ press: 'Tab' });
    await sendKeys({ type: 'one' });
    const icon = host?.shadowRoot?.querySelector('[data-test="magnifying-glass-icon"]');
...
it('hides its magnifying glass icon when single-select and the filter is the label of its selected option', async () => {
    ...
    const option = [...host.querySelectorAll('glide-core-dropdown-option')].find(({ hidden }) => !hidden);
    await click(option);
    await sendKeys({ type: 'One' });
    const icon = host?.shadowRoot?.querySelector('[data-test="magnifying-glass-icon"]');
    expect(icon?.checkVisibility()).to.be.not.ok;
...
it('shows its magnifying glass icon when multiselect and filtering', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label" filterable multiple>
      <glide-core-dropdown-option label="One"></glide-core-dropdown-option>
      <glide-core-dropdown-option label="Two"></glide-core-dropdown-option>
    </glide-core-dropdown>`);
    await sendKeys({ press: 'Tab' });
...
it('clears its filter on close when multiselect and no option is selected', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label" filterable multiple open>
      <glide-core-dropdown-option label="One"></glide-core-dropdown-option>
      <glide-core-dropdown-option label="Two"></glide-core-dropdown-option>
    </glide-core-dropdown>`);
    // Wait for Floating UI.
...
it('hides Select All when filtering', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label" filterable open multiple select-all>
      <glide-core-dropdown-option label="One"></glide-core-dropdown-option>
      <glide-core-dropdown-option label="Two"></glide-core-dropdown-option>
    </glide-core-dropdown>`);
    await sendKeys({ press: 'Tab' });
...
it('sets the first unfiltered option as active when the previously active option is filtered out', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label" filterable multiple select-all>
      <glide-core-dropdown-option label="One"></glide-core-dropdown-option>
      <glide-core-dropdown-option label="Two"></glide-core-dropdown-option>
    </glide-core-dropdown>`);
    await sendKeys({ press: 'Tab' });
...
it('uses `placeholder` as a placeholder when multiselect and no option is selected', async () => {
    const host = await fixture(html `<glide-core-dropdown
      label="Label"
...
it('sets `aria-activedescendant` on option hover', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label" open>
      <glide-core-dropdown-option label="One"></glide-core-dropdown-option>
      <glide-core-dropdown-option label="Two"></glide-core-dropdown-option>
    </glide-core-dropdown>`);
    // Wait for Floating UI.
...
it('sets `aria-activedescendant` on ArrowDown', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label" filterable open multiple>
      <glide-core-dropdown-option label="One"></glide-core-dropdown-option>
      <glide-core-dropdown-option label="Two"></glide-core-dropdown-option>
    </glide-core-dropdown>`);
    // Wait for Floating UI.
...
it('sets `aria-activedescendant` on ArrowUp', async () => {
    ...
    await sendKeys({ press: 'ArrowDown' });
    const input = host.shadowRoot?.querySelector('[data-test="input"]');
    const option = host.querySelector('glide-core-dropdown-option:nth-of-type(2)');
    expect(input?.getAttribute('aria-activedescendant')).to.equal(option?.id);
});
it('sets `aria-activedescendant` on ArrowUp', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label" filterable open multiple>
...
it('cannot be tabbed to when disabled', async () => {
    await fixture(html `<glide-core-dropdown label="Label" filterable multiple disabled>
      <glide-core-dropdown-option label="One"></glide-core-dropdown-option>
      <glide-core-dropdown-option label="Two"></glide-core-dropdown-option>
    </glide-core-dropdown>`);
    await sendKeys({ press: 'Tab' });
...
it('has no icon when filtering and an option is selected', async () => {
    ...
    await sendKeys({ press: 'Tab' });
    await sendKeys({ type: 'one' });
    const iconSlot = host.shadowRoot?.querySelector('[data-test="single-select-icon-slot"]');
