 ...
 * @fires {Event} remove
 */
let GlideCoreInlineAlert = class GlideCoreInlineAlert extends LitElement {
    constructor() {
        super(...arguments);
    ...
    render() {
      ...
      >
        ...
        ${when(this.removable, () => html `<glide-core-icon-button
...
], GlideCoreInlineAlert.prototype, "variant", void 0);
__decorate([
    property({ reflect: true, type: Boolean })
], GlideCoreInlineAlert.prototype, "removable", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreInlineAlert.prototype, "version", void 0);
GlideCoreInlineAlert = __decorate([
    customElement('glide-core-inline-alert'),
    final
], GlideCoreInlineAlert);
export default GlideCoreInlineAlert;
const icons = {
