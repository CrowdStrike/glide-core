...
let GlideCoreSubclassed = class GlideCoreSubclassed extends GlideCoreButtonGroup {
};
...
it('is accessible', async () => {
    const host = await fixture(html `<glide-core-button-group label="Label">
...
it('sets the orientation of its buttons when vertical', async () => {
    const host = await fixture(html `<glide-core-button-group label="Label" orientation="vertical">
      <glide-core-button-group-button
        label="One"
      ></glide-core-button-group-button>
...
it('sets `privateVariant` on its buttons', async () => {
    const host = await fixture(html `<glide-core-button-group label="Label" variant="icon-only">
