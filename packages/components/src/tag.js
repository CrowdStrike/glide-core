 ...
 * @fires {Event} remove
 */
let GlideCoreTag = class GlideCoreTag extends LitElement {
    constructor() {
        super(...arguments);
        this.disabled = false;
...
], GlideCoreTag.prototype, "disabled", void 0);
__decorate([
    property({ reflect: true }),
    required
], GlideCoreTag.prototype, "label", void 0);
__decorate([
    property({ attribute: 'private-editable', reflect: true, type: Boolean })
], GlideCoreTag.prototype, "privateEditable", void 0);
__decorate([
    property({ reflect: true, type: Boolean })
], GlideCoreTag.prototype, "removable", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreTag.prototype, "size", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreTag.prototype, "version", void 0);
GlideCoreTag = __decorate([
    customElement('glide-core-tag'),
    final
], GlideCoreTag);
export default GlideCoreTag;
