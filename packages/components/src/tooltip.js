 ...
 * @fires {Event} toggle
 */
let GlideCoreTooltip = class GlideCoreTooltip extends LitElement {
    constructor() {
        super(...arguments);
...
], GlideCoreTooltip.prototype, "disabled", null);
__decorate([
    property({ reflect: true }),
    required
], GlideCoreTooltip.prototype, "label", null);
__decorate([
    property({ reflect: true, type: Number })
], GlideCoreTooltip.prototype, "offset", null);
__decorate([
    property({ reflect: true, type: Boolean })
], GlideCoreTooltip.prototype, "open", null);
__decorate([
    property({ reflect: true })
], GlideCoreTooltip.prototype, "placement", void 0);
__decorate([
    property({ attribute: 'screenreader-hidden', reflect: true, type: Boolean })
], GlideCoreTooltip.prototype, "screenreaderHidden", null);
__decorate([
    property({ reflect: true, type: Array })
], GlideCoreTooltip.prototype, "shortcut", null);
__decorate([
    property({ reflect: true })
], GlideCoreTooltip.prototype, "version", void 0);
__decorate([
    state()
], GlideCoreTooltip.prototype, "effectivePlacement", void 0);
GlideCoreTooltip = __decorate([
    customElement('glide-core-tooltip'),
    final
], GlideCoreTooltip);
export default GlideCoreTooltip;
const icons = {
