...
const meta = {
    ...
    play(context) {
        context.canvasElement
            ...
            const isMenuLink = event.target instanceof Element &&
        ...
        const secondaryButton = context.canvasElement.querySelector('glide-core-split-button-secondary-button');
        const observer = new MutationObserver(() => {
            addons.getChannel().emit(UPDATE_STORY_ARGS, {
                storyId: context.id,
                updatedArgs: {
                    ['<glide-core-split-button-secondary-button>.menu-open']: context.canvasElement.querySelector('glide-core-split-button-secondary-button')?.menuOpen,
                },
            });
        });
        if (secondaryButton) {
    ...
    render(arguments_) {
      ...
      >
        <glide-core-split-button-primary-button
          label=${arguments_['<glide-core-split-button-primary-button>.label'] || nothing}
          ?disabled=${arguments_['<glide-core-split-button-primary-button>.disabled']}
        ></glide-core-split-button-primary-button>

        <glide-core-split-button-secondary-button
          label=${arguments_['<glide-core-split-button-secondary-button>.label'] || nothing}
          menu-placement=${arguments_['<glide-core-split-button-secondary-button>.menu-placement']}
          slot="secondary-button"
          ?disabled=${arguments_['<glide-core-split-button-secondary-button>.disabled']}
          ?menu-open=${arguments_['<glide-core-split-button-secondary-button>.menu-open']}
        >
    ...
    argTypes: {
        'slot="default"': {
            table: {
                type: {
                    summary: 'GlideCoreSplitButtonPrimaryButton | GlideCoreSplitButtonPrimaryLink',
                },
            },
        ...
        '<glide-core-split-button-primary-button>.addEventListener(event, handler)': {
            ...
            table: {
                ...
                type: {
                    summary: 'method',
                    detail: '(event: "click", handler: (event: PointerEvent) => void): void',
                },
            },
        },
    ...
    render(arguments_) {
      ...
      >
        <glide-core-split-button-primary-link
          ...
          ?disabled=${arguments_['<glide-core-split-button-primary-link>.disabled']}
        >
        </glide-core-split-button-primary-link>

        <glide-core-split-button-secondary-button
          label=${arguments_['<glide-core-split-button-secondary-button>.label']}
          ?menu-open=${arguments_['<glide-core-split-button-secondary-button>.menu-open']}
          menu-placement=${arguments_['<glide-core-split-button-secondary-button>.menu-placement']}
          slot="secondary-button"
          ?disabled=${arguments_['<glide-core-split-button-secondary-button>.disabled']}
