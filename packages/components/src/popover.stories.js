    ...
    argTypes: {
        ...
        'slot="target"': {
            table: {
                type: {
                    summary: 'Element',
                    detail: '// The element to which the popover will anchor. Can be any focusable element',
                },
            },
        ...
        open: {
            table: {
                ...
                type: {
                    summary: 'boolean',
                    detail: '// Force visibility of the popover. Useful when it should be visible based on something other than a click.',
                },
            },
        },
        placement: {
            ...
            table: {
                ...
                type: {
                    ...
                    detail: '// The popover will try to move itself to the opposite of this value if not doing so would result in\n// overflow. For example, if "bottom" results in overflow Popover will try "top" but not "right"\n// or "left".',
                },
            },
        },
        version: {
