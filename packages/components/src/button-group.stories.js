...
const meta = {
    ...
    play(context) {
        const buttonGroup = context.canvasElement.querySelector('glide-core-button-group');
        buttonGroup?.addEventListener('selected', (event) => {
            if (event.target instanceof GlideCoreButton) {
                addons.getChannel().emit(UPDATE_STORY_ARGS, {
                    storyId: context.id,
                    updatedArgs: {
                        '<glide-core-button-group-button>.one.selected': event.target.label === 'One',
                        '<glide-core-button-group-button>.two.selected': event.target.label === 'Two',
                        '<glide-core-button-group-button>.three.selected': event.target.label === 'Three',
                    },
                });
            }
        });
    ...
    render(arguments_) {
      ...
      >
        ${when(arguments_.variant === 'icon-only', () => {
            return html `<glide-core-button-group-button
                ...
                ?selected=${arguments_['<glide-core-button-group-button>.one.selected']}
              >
              ...
              <glide-core-button-group-button
                label="Two"
                ?selected=${arguments_['<glide-core-button-group-button>.two.selected']}
              >
                <glide-core-example-icon
                  slot="icon"
                  name="edit"
              ...
              <glide-core-button-group-button
                label="Three"
                ?selected=${arguments_['<glide-core-button-group-button>.three.selected']}
              >
                <glide-core-example-icon
                  slot="icon"
                  name="calendar"
    ...
    argTypes: {
        ...
        '<glide-core-button-group-button>.value': {
            ...
            table: {
                ...
                type: {
                    summary: 'string',
                    detail: '// Set `value` when you need something other than `label` to identify the selected button',
                },
            },
        },
        '<glide-core-button-group-button>.version': {
