 ...
 * @param {string} [message]
 */
let GlideCoreDropdown = class GlideCoreDropdown extends LitElement {
    ...
    get selectedOptions() {
        return this.#optionElements.filter((option) => {
    ...
    firstUpdated() {
        ...
        if (hasNoSelectedOptions) {
            for (const option of this.#optionElements) {
                ...
                option.selected = this.value.some((value) => value !== '' && value === option.value);
                if (option.selected && option.disabled) {
                    option.disabled = false;
                }
            }
    ...
    formResetCallback() {
        ...
        const initiallySelectedOptionElementsWithValue = this.#optionElements.filter((option) => {
        ...
        >
          ...
          >
            <span class="selected-option-labels" id="selected-option-labels">
              ${this.selectedOptions.map(({ label }) => html `<span data-test="selected-option-label">
                    ${label},
                  </span>`)}
            </span>
            ...
            return html `<ul
              ...
              >
                ${repeat(this.selectedOptions, ({ id }) => id, ({ id, editable, label, value }, index) => {
                return html `<li
                      class=${classMap({
                    'tag-container': true,
            ...
            return html `<div
              ...
              ${when(!this.multiple && this.selectedOptions[0]?.editable, () => {
            return html `<glide-core-icon-button
                    class="edit-button"
                    data-test="edit-button"
                    label=${this.#localize.term('editOption', this.selectedOptions[0].label)}
    ...
    constructor() {
        ...
        this.isInternalLabelOverflow = false;
        ...
        this.#optionsAndFooterElementRef = createRef();
    ...
    // Used in `#onOptionsSelectedChange` to guard against resetting Select All
    // back to its previous value after Select All is selected or deselected.
    #isSelectionChangeFromSelectAll;
    #isSelectionViaSpaceOrEnter;
    #isSettingValueProgrammatically;
    #localize;
    #optionsAndFooterElementRef;
    ...
    async #onDefaultSlotChange() {
        ...
        const firstOption = this.#optionElementsNotHiddenIncludingSelectAll?.find((option) => !option.disabled);
    ...
    #onDropdownAndOptionsFocusin(event) {
    ...
    #onInputKeydown(event) {
        ...
        const lastSelectedAndNotOverflowingOption = this.selectedOptions.findLast((_, index) => index <= this.tagOverflowLimit - 1);
        ...
        const selectedAndNotOverflowingOptions = this.selectedOptions.filter((_, index) => index <= this.tagOverflowLimit - 1);
        if (lastSelectedAndNotOverflowingOption &&
            event.key === 'Backspace' &&
            event.metaKey &&
            this.multiple &&
    ...
    get #optionElements() {
        return (this.#defaultSlotElementRef.value
            ?.assignedElements()
            .filter((element) => element instanceof GlideCoreDropdownOption) ?? []);
    }
    ...
    get #optionElementsNotHidden() {
        return this.#defaultSlotElementRef.value
            ?.assignedElements()
            .filter((element) => element instanceof GlideCoreDropdownOption && !element.hidden);
    }
    ...
    #onOptionsClick(event) {
        if (event.target instanceof Element) {
            ...
            if (option instanceof GlideCoreDropdownOption &&
                ...
                this.#value =
                    event.target.selected && event.target.value && !event.target.disabled
                        ...
                        : this.value.filter((value) => {
                            return (event.target instanceof GlideCoreDropdownOption &&
    ...
    async #onTagRemove(id) {
        ...
        if (tags && this.selectedOptions.length > 0) {
            const removedTagIndex = [...tags].findIndex((tag) => tag.dataset.id === id);
    ...
    #show() {
        if (this.#optionElements.length > 0) {
            ...
            if (this.#dropdownElementRef.value &&
                ...
                this.#cleanUpFloatingUi = autoUpdate(this.#dropdownElementRef.value, this.#optionsAndFooterElementRef.value, () => {
                    (async () => {
                        if (this.#dropdownElementRef.value &&
                            this.#optionsAndFooterElementRef.value) {
                            const { x, y, placement } = await computePosition(this.#dropdownElementRef.value, this.#optionsAndFooterElementRef.value, {
...
], GlideCoreDropdown.prototype, "addButtonLabel", void 0);
__decorate([
    property({ reflect: true, type: Boolean })
], GlideCoreDropdown.prototype, "disabled", null);
__decorate([
    property({ reflect: true, type: Boolean })
], GlideCoreDropdown.prototype, "filterable", null);
__decorate([
    property({ attribute: 'hide-label', reflect: true, type: Boolean })
], GlideCoreDropdown.prototype, "hideLabel", void 0);
__decorate([
    property({ reflect: true }),
    required
], GlideCoreDropdown.prototype, "label", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreDropdown.prototype, "name", void 0);
__decorate([
    property({ reflect: true, type: Boolean })
], GlideCoreDropdown.prototype, "open", null);
__decorate([
    property({ reflect: true })
], GlideCoreDropdown.prototype, "orientation", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreDropdown.prototype, "placeholder", void 0);
__decorate([
    property()
], GlideCoreDropdown.prototype, "privateSplit", void 0);
__decorate([
    property({ reflect: true, type: Boolean })
], GlideCoreDropdown.prototype, "readonly", void 0);
__decorate([
    property({ attribute: 'select-all', reflect: true, type: Boolean })
], GlideCoreDropdown.prototype, "selectAll", void 0);
__decorate([
    property({ reflect: true, type: Boolean })
], GlideCoreDropdown.prototype, "required", void 0);
__decorate([
    property({ reflect: true, type: Boolean })
], GlideCoreDropdown.prototype, "multiple", null);
__decorate([
    property({ reflect: true })
], GlideCoreDropdown.prototype, "size", null);
__decorate([
    property({ reflect: true })
], GlideCoreDropdown.prototype, "tooltip", void 0);
__decorate([
    property({ type: Array })
], GlideCoreDropdown.prototype, "value", null);
__decorate([
    property({ reflect: true })
], GlideCoreDropdown.prototype, "variant", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreDropdown.prototype, "version", void 0);
__decorate([
    state()
], GlideCoreDropdown.prototype, "ariaActivedescendant", void 0);
__decorate([
    state()
], GlideCoreDropdown.prototype, "inputValue", void 0);
__decorate([
    state()
], GlideCoreDropdown.prototype, "isBlurring", void 0);
__decorate([
    state()
], GlideCoreDropdown.prototype, "isCheckingValidity", void 0);
__decorate([
    state()
], GlideCoreDropdown.prototype, "isCommunicateItemCountToScreenreaders", void 0);
__decorate([
    state()
], GlideCoreDropdown.prototype, "isFilterable", void 0);
__decorate([
    state()
], GlideCoreDropdown.prototype, "isFiltering", void 0);
__decorate([
    state()
], GlideCoreDropdown.prototype, "isInputOverflow", void 0);
__decorate([
    state()
], GlideCoreDropdown.prototype, "isInputTooltipOpen", void 0);
__decorate([
    state()
], GlideCoreDropdown.prototype, "isInternalLabelOverflow", void 0);
__decorate([
    state()
], GlideCoreDropdown.prototype, "isInternalLabelTooltipOpen", void 0);
__decorate([
    state()
], GlideCoreDropdown.prototype, "isNoResults", void 0);
__decorate([
    state()
], GlideCoreDropdown.prototype, "isReportValidityOrSubmit", void 0);
__decorate([
    state()
], GlideCoreDropdown.prototype, "isShowSingleSelectIcon", void 0);
__decorate([
    state()
], GlideCoreDropdown.prototype, "itemCount", void 0);
__decorate([
    state()
], GlideCoreDropdown.prototype, "tagOverflowLimit", void 0);
__decorate([
    state()
], GlideCoreDropdown.prototype, "validityMessage", void 0);
GlideCoreDropdown = __decorate([
