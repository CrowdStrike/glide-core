    ...
    argTypes: {
        ...
        'slot="target"': {
            table: {
                type: {
                    summary: 'Element',
                    detail: '// The element to which the tooltip will anchor. Can be any element with an implicit or explicit ARIA role.',
                },
            },
        ...
        open: {
            table: {
                ...
                type: {
                    summary: 'boolean',
                    detail: '// Force visibility of the tooltip. Useful when it should be visible based on something other than\n// hover or focus.',
                },
            },
        },
        placement: {
            ...
            table: {
                ...
                type: {
                    ...
                    detail: '// The tooltip will try to move itself to the opposite of this value if not doing so would result in\n// overflow. For example, if "bottom" results in overflow Tooltip will try "top" but not "right"\n// or "left".',
                },
            },
        },
        'screenreader-hidden': {
