...
it('can be reset', async () => {
    ...
    const host = await fixture(html `<glide-core-checkbox-group label="Label">
      <glide-core-checkbox
        label="Label"
        value="value"
        checked
...
it('has `formData` when the checkboxes are checked', async () => {
    const form = document.createElement('form');
    await fixture(html `<glide-core-checkbox-group label="Label" name="name">
      <glide-core-checkbox
        label="One"
        value="one"
        checked
...
it('has no `formData` when disabled and the checkbox is checked', async () => {
    const form = document.createElement('form');
    await fixture(html `<glide-core-checkbox-group label="Label" name="name" disabled>
      <glide-core-checkbox
        label="Label"
        value="value"
        checked
...
it('has no `formData` when without a `name` but the checkbox is checked', async () => {
    const form = document.createElement('form');
    await fixture(html `<glide-core-checkbox-group label="Label">
      <glide-core-checkbox
        label="Label"
        value="value"
        checked
...
it('is valid if required and its checkbox is checked', async () => {
    const host = await fixture(html `<glide-core-checkbox-group label="Label" required>
      <glide-core-checkbox label="Label" value="value"></glide-core-checkbox>
    </glide-core-checkbox-group>`);
...
it('is both invalid and valid if required and disabled and its checkbox is unchecked', async () => {
    const host = await fixture(html `<glide-core-checkbox-group label="Label" disabled required>
      <glide-core-checkbox label="Label" value="value"></glide-core-checkbox>
    </glide-core-checkbox-group>`);
    expect(host.validity.valid).to.be.false;
    expect(host.validity?.valueMissing).to.be.true;
