...
let GlideCoreSubclassed = class GlideCoreSubclassed extends GlideCoreDropdown {
};
...
it('selects options when `value` is set initially', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label" .value=${['two']}>
      <glide-core-dropdown-option
        label="One"
        value="one"
      ></glide-core-dropdown-option>
...
it('enables options when `value` is set initially', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label" .value=${['one']}>
      <glide-core-dropdown-option
        label="one"
        value="one"
        disabled
...
it('throws when its default slot is the wrong type', async () => {
    await expectWindowError(() => {
        return fixture(html `<glide-core-dropdown label="Label">
