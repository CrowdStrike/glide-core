...
let GlideCoreExampleIcon = class GlideCoreExampleIcon extends LitElement {
    constructor() {
        super(...arguments);
        this.icons = icons;
    }
...
__decorate([
    property()
], GlideCoreExampleIcon.prototype, "name", void 0);
GlideCoreExampleIcon = __decorate([
    customElement('glide-core-example-icon')
], GlideCoreExampleIcon);
export default GlideCoreExampleIcon;
const icons = {
    edit: svg `
    <path
