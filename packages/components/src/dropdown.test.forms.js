...
it('submits its form on Enter when closed', async () => {
    ...
    await fixture(html `<glide-core-dropdown label="Label">
...
it('does not submit its form on Enter when open', async () => {
    const form = document.createElement('form');
    await fixture(html `<glide-core-dropdown label="Label" open>
      <glide-core-dropdown-option label="Label"></glide-core-dropdown-option>
    </glide-core-dropdown>`, {
        parentNode: form,
    });
...
it('is invalid if required and no option is selected', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label" required>
      <glide-core-dropdown-option label="Label"></glide-core-dropdown-option>
    </glide-core-dropdown>`);
...
it('is invalid if required and no option is selected when `filterable`', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label" filterable required>
      <glide-core-dropdown-option label="Label"></glide-core-dropdown-option>
    </glide-core-dropdown>`);
    expect(host.validity.valid).to.be.false;
    expect(host.validity?.valueMissing).to.be.true;
...
it('is both invalid and valid if required and disabled and no option is selected', async () => {
    const host = await fixture(html `<glide-core-dropdown label="Label" disabled required>
      <glide-core-dropdown-option label="Label"></glide-core-dropdown-option>
    </glide-core-dropdown>`);
    expect(host.validity.valid).to.be.false;
    expect(host.validity?.valueMissing).to.be.true;
