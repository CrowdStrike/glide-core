 ...
 * @method open
 */
let GlideCoreToast = class GlideCoreToast extends LitElement {
    constructor() {
        super(...arguments);
        this.duration = 5000;
    ...
    close() {
        this.#componentElementRef.value?.addEventListener('transitionend', () => {
...
], GlideCoreToast.prototype, "label", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreToast.prototype, "description", void 0);
__decorate([
    property({ type: Number })
], GlideCoreToast.prototype, "duration", void 0);
__decorate([
    property()
], GlideCoreToast.prototype, "variant", void 0);
GlideCoreToast = __decorate([
