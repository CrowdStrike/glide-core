 ...
 * @fires {Event} change
 */
let GlideCoreToggle = class GlideCoreToggle extends LitElement {
    constructor() {
        super(...arguments);
        this.checked = false;
        this.disabled = false;
...
], GlideCoreToggle.prototype, "checked", void 0);
__decorate([
    property({ reflect: true, type: Boolean })
], GlideCoreToggle.prototype, "disabled", void 0);
__decorate([
    property({ attribute: 'hide-label', type: Boolean })
], GlideCoreToggle.prototype, "hideLabel", void 0);
__decorate([
    property({ reflect: true }),
    required
], GlideCoreToggle.prototype, "label", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreToggle.prototype, "orientation", void 0);
__decorate([
    property()
], GlideCoreToggle.prototype, "privateSplit", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreToggle.prototype, "summary", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreToggle.prototype, "tooltip", void 0);
__decorate([
    property({ reflect: true })
], GlideCoreToggle.prototype, "version", void 0);
GlideCoreToggle = __decorate([
