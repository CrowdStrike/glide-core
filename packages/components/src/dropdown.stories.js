    ...
    argTypes: {
        ...
        'addEventListener(event, handler)': {
            ...
            table: {
                type: {
                    summary: 'method',
                    detail: '(event: "add" | "change" | "input" | "invalid" | "toggle", handler: (event: Event) => void): void',
                },
            },
        },
        'checkValidity()': {
        ...
        filterable: {
            table: {
                ...
                type: {
                    summary: 'boolean',
                    detail: '// Dropdown will be filterable regardless of this attribute when there are more than 10 options',
                },
            },
        },
        'filter(query, options)': {
...
`,
    ...
    >
      <glide-core-dropdown-option
        ...
        ?selected=${arguments_.value.includes(arguments_['<glide-core-dropdown-option>.one.value'])}
      ></glide-core-dropdown-option>

      <glide-core-dropdown-option
        label="Two"
        value="two"
        ?selected=${arguments_.value.includes(arguments_['<glide-core-dropdown-option>.two.value'])}
      ></glide-core-dropdown-option>

      <glide-core-dropdown-option
        label="Three"
        value="three"
        ?selected=${arguments_.value.includes(arguments_['<glide-core-dropdown-option>.three.value'])}
      ></glide-core-dropdown-option>
