...
declare global {
  interface HTMLElementTagNameMap {
    'cs-multiselect': CsMultiselect;
  }
}

/**
 * @description A multiselect with an optional tooltip.
 ...
 *
 * @slot - One or more of `<cs-multiselect-option>`.
 * @slot tooltip - Content for the tooltip.
 */
@customElement('cs-dropdown')
export default class CsMultiselect extends LitElement {
  ...
  #onDocumentClick = (event: MouseEvent) => {
    if (!(event.target instanceof CsMultiselect)) {
      this.open = false;
    }
  };
